...
| MCP client (optional) | Connect `@daven/mcp` in the AI coding tool you already use |
...
| `@daven/mcp` | MCP server so your AI coding tool can call Daven while you build |
...
<Steps>
  ...
  <Step title="Connect your MCP client (optional)">
    Add `@daven/mcp` in the MCP settings of the AI coding platform you use. See the example config under Settings → Developer / MCP.
