...
<CardGroup cols={2}>
  <Card title="채팅하면서 만들기" icon="pen-to-square" href="/essentials/markdown">
    Learn MDX syntax and start writing your documentation.
  </Card>
  <Card title="앱 사용하기" icon="palette" href="/essentials/settings">
    Make your docs match your brand perfectly.
  </Card>
  <Card title="쇼츠 만들기 " icon="square-code" href="/essentials/code">
    Include syntax-highlighted code blocks.
  </Card>
  <Card title="예약작업 만들기" icon="code" href="/api-reference/introduction">
...
<CardGroup cols={2}>
  <Card title="캐릭터 만들기" icon="pen-to-square" href="/essentials/markdown">
    Learn MDX syntax and start writing your documentation.
  </Card>
  <Card title="캐릭터로 컨텐츠 만들기" icon="palette" href="/essentials/settings">
    Make your docs match your brand perfectly.
  </Card>
  <Card title="만화 만들기" icon="square-code" href="/essentials/code">
    Include syntax-highlighted code blocks.
  </Card>
  <Card title="예약작업 만들기" icon="code" href="/api-reference/introduction">
    Auto-generate API docs from OpenAPI specs.
